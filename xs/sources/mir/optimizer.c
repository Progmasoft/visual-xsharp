...
static bool is_i32_fold_candidate(XsMirInstructionKind kind)
{
    return kind == XS_MIR_INSTRUCTION_ADD_I32 || kind == XS_MIR_INSTRUCTION_SUB_I32 ||
           ...
           kind == XS_MIR_INSTRUCTION_EQ_I32 || kind == XS_MIR_INSTRUCTION_NE_I32 ||
           kind == XS_MIR_INSTRUCTION_LT_I32 || kind == XS_MIR_INSTRUCTION_LE_I32 ||
           kind == XS_MIR_INSTRUCTION_GT_I32 || kind == XS_MIR_INSTRUCTION_GE_I32;
}

static bool is_i32_bool_result(XsMirInstructionKind kind)
{
    return kind == XS_MIR_INSTRUCTION_EQ_I32 || kind == XS_MIR_INSTRUCTION_NE_I32 ||
           kind == XS_MIR_INSTRUCTION_LT_I32 || kind == XS_MIR_INSTRUCTION_LE_I32 ||
           kind == XS_MIR_INSTRUCTION_GT_I32 || kind == XS_MIR_INSTRUCTION_GE_I32;
}
