...
extern "C"
{
    ...
    XsMirStatus xs_mir_module_add_function_definition(XsMirModule *module, const char *qualified_name,
                                                      XsMirType return_type, const XsMirType *parameters,
                                                      size_t parameter_count, XsMirFunction **function,
                                                      XsMirError *error);
    ...
    XsMirStatus xs_mir_function_add_local(XsMirFunction *function, XsMirLocalKind kind, const char *name,
                                          XsMirType type, bool is_mutable, XsMirLocalId *local, XsMirError *error);
    ...
    XsMirStatus xs_mir_block_add_store(XsMirBlock *block, const XsMirPlace *place, XsMirValueId value,
                                       XsMirError *error);
