...
[[nodiscard]] auto WriteBytes(const std::filesystem::path &path, const char *bytes, std::size_t size)
    -> std::optional<Error>
{
...
auto WriteBitcode(const std::filesystem::path &path, const std::vector<std::uint8_t> &bitcode) -> std::optional<Error>
{
...
auto WriteObject(const std::filesystem::path &path, const std::vector<std::uint8_t> &object) -> std::optional<Error>
{
...
auto WriteAssembly(const std::filesystem::path &path, std::string_view assembly) -> std::optional<Error>
{
