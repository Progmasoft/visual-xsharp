...
public record XlilFunction(String name, XlilType returnType, List<XlilType> parameterTypes,
        List<Integer> parameterValues, List<XlilType> valueTypes, List<XlilType> slots, boolean definition,
