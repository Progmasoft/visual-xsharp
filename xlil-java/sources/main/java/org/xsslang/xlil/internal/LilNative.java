...
public final class LilNative
{
    public static final ValueLayout.OfInt C_INT = (ValueLayout.OfInt) Linker.nativeLinker().canonicalLayouts()
            .get("int");
    public static final ValueLayout.OfLong C_INT64 = (ValueLayout.OfLong) Linker.nativeLinker().canonicalLayouts()
            .get("int64_t");
    public static final ValueLayout.OfLong C_SIZE = (ValueLayout.OfLong) Linker.nativeLinker().canonicalLayouts()
            .get("size_t");
    public static final ValueLayout.OfShort C_UINT16 = (ValueLayout.OfShort) Linker.nativeLinker().canonicalLayouts()
            .get("uint16_t");
    public static final ValueLayout.OfBoolean C_BOOL = (ValueLayout.OfBoolean) Linker.nativeLinker().canonicalLayouts()
            .get("bool");
    public static final ValueLayout.OfInt C_INT32 = (ValueLayout.OfInt) Linker.nativeLinker().canonicalLayouts()
            .get("int32_t");
    public static final java.lang.foreign.AddressLayout ADDRESS = ValueLayout.ADDRESS;
    public static final MemoryLayout TYPE_LAYOUT = MemoryLayout.structLayout(C_INT.withName("kind"),
            C_INT32.withName("registry_id"));
    ...
    static
    {
        ...
        {
            throw new ExceptionInInitializerError("incompatible xs_lil C API: expected 0x"
                    + Integer.toHexString(API_VERSION) + ", got 0x" + Integer.toHexString(version));
        }
    }
    ...
    {
        MemorySegment address = callAddress("xs_lil_error_message", FunctionDescriptor.of(ADDRESS, ADDRESS), error);
    ...
    public static short callShort(String name, FunctionDescriptor descriptor, Object... arguments)
    {
        return (short) invoke(name, descriptor, arguments);
    }

    public static boolean callBoolean(String name, FunctionDescriptor descriptor, Object... arguments)
    {
        return (boolean) invoke(name, descriptor, arguments);
    }

    public static MemorySegment callAddress(String name, FunctionDescriptor descriptor, Object... arguments)
    {
        return (MemorySegment) invoke(name, descriptor, arguments);
    }

    public static MemorySegment callType(Arena arena, String name, FunctionDescriptor descriptor, Object... arguments)
    {
    ...
    private static Object invoke(String name, FunctionDescriptor descriptor, Object... arguments)
    {
        try
        {
    ...
    private static MethodHandle handle(String name, FunctionDescriptor descriptor)
    {
        ...
        return HANDLES.computeIfAbsent(signature,
