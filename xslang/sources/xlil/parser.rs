...
impl Parser<'_>
{
    ...
    fn function(&mut self) -> Option<Function>
    {
        ...
        self.report(
            DiagnosticCode::InvalidFunctionRecord,
            line_number,
    ...
    fn body(&mut self, function: &mut Function)
    {
        ...
        while self.cursor < self.lines.len()
        {
            ...
            {
                self.report(
                    DiagnosticCode::InvalidBlockRecord,
                    self.line_number(),
    ...
    fn instruction(&mut self, function: &mut Function, text: &str, line: usize) -> Option<Instruction>
    {
        ...
        for instruction in [
            "div.i64", "rem.i64", "and.i64", "or.i64", "xor.i64", "shl.i64", "shr.i64", "lt.i64", "le.i64", "gt.i64",
            "ge.i64",
        ]
        {
        ...
        for instruction in [
            ...
            "shr.i32", "eq.i32", "lt.i32", "le.i32", "gt.i32", "ge.i32",
        ]
        {
            let pattern = format!(" = {instruction} ");
            if let Some((result, operands)) = text.split_once(&pattern)
        ...
        Some(Instruction::ConstI64 {
            result,
            value,
        })
    }
}
include!("parser/instruction_tail.rs");
