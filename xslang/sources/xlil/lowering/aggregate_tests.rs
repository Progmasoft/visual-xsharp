...
{
    let typed_local = |id, value_type| Local {
        id: LocalId(id),
        name: format!("$tmp{id}"),
        ...
        blocks: vec![BasicBlock {
            ...
            statements: vec![
                ...
                Statement::Aggregate {
                    ...
                    field_types: vec![Type::I32, Type::I32],
                    span: span(),
                },
                Statement::Extract {
                    result: LocalId(3),
    ...
    assert!(matches!(
        lowered.blocks[0].instructions[2],
        Instruction::Aggregate { .. }
    ));
    assert!(matches!(lowered.blocks[0].instructions[3], Instruction::Extract {
        field: 0,
        ..
    }));
}
