...
fn lowers_void_return_function_skeleton()
{
    ...
    let lowered = MirToXlilLowerer::new()
...
fn rejects_return_value_without_type_and_value_mapping()
{
    ...
    let diagnostics = MirToXlilLowerer::new()
        .lower_function(&function)
...
fn lowers_i64_const_and_return_value()
{
    let function = MirFunction {
        ...
        blocks: vec![BasicBlock {
            id: MirBlockId(0),
            statements: vec![mir::Statement::ConstI64 {
                local: LocalId(0),
                value: 42,
                span: span(1, 2),
            }],
    ...
    assert_eq!(lowered.blocks[0].instructions, vec![Instruction::ConstI64 {
        result: crate::xlil::ValueId(0),
        value: 42
    }]);
    assert_eq!(
...
fn lowers_i32_const_and_return_value()
{
    let function = MirFunction {
        ...
        blocks: vec![BasicBlock {
            id: MirBlockId(0),
            statements: vec![mir::Statement::ConstI32 {
                local: LocalId(0),
                value: 0,
                span: span(1, 2),
            }],
    ...
    assert_eq!(lowered.blocks[0].instructions, vec![Instruction::ConstI32 {
        result: crate::xlil::ValueId(0),
        value: 0
    }]);
}
...
fn lowers_add_i64_statement()
{
    ...
    assert_eq!(lowered.blocks[0].instructions[2], Instruction::AddI64 {
        result: crate::xlil::ValueId(2),
        left: crate::xlil::ValueId(0),
        right: crate::xlil::ValueId(1)
    });
    assert_eq!(
        lowered.blocks[0].terminator,
...
fn lowers_sub_i64_statement()
{
    ...
    assert_eq!(lowered.blocks[0].instructions[2], Instruction::SubI64 {
        result: crate::xlil::ValueId(2),
        left: crate::xlil::ValueId(0),
        right: crate::xlil::ValueId(1)
    });
...
fn lowers_mul_i64_statement()
{
    ...
    assert_eq!(lowered.blocks[0].instructions[2], Instruction::MulI64 {
        result: crate::xlil::ValueId(2),
        left: crate::xlil::ValueId(0),
        right: crate::xlil::ValueId(1)
    });
...
fn lowers_const_bool_and_eq_i64_statement()
{
    ...
    assert_eq!(lowered.blocks[0].instructions[2], Instruction::EqI64 {
        result: crate::xlil::ValueId(2),
        left: crate::xlil::ValueId(0),
        right: crate::xlil::ValueId(1)
    });
...
fn lowers_i32_instruction_family()
{
    let function = MirFunction {
        ...
        blocks: vec![BasicBlock {
            ...
            statements: vec![
                ...
                mir::Statement::AddI32 {
                    result: LocalId(2),
                    left: LocalId(0),
                    right: LocalId(1),
                    span: span(3, 4),
                },
                mir::Statement::SubI32 {
                    result: LocalId(2),
                    left: LocalId(0),
                    right: LocalId(1),
                    span: span(4, 5),
                },
                mir::Statement::MulI32 {
                    result: LocalId(2),
                    left: LocalId(0),
                    right: LocalId(1),
                    span: span(5, 6),
    ...
    assert_eq!(lowered.blocks[0].instructions[2], Instruction::AddI32 {
        result: crate::xlil::ValueId(2),
        left: crate::xlil::ValueId(0),
        right: crate::xlil::ValueId(1)
    });
...
{
    let function = MirFunction {
        name: "BadBranchIfType".to_string(),
        parameters: vec![],
        return_type: Type::VOID,
        locals: vec![Local {
            id: LocalId(0),
        ...
        blocks: vec![
            BasicBlock {
                ...
                terminator: Some(mir::Terminator::BranchIf {
                    condition: LocalId(0),
    ...
    assert_eq!(diagnostics, vec![Diagnostic {
        code: DiagnosticCode::UnsupportedLocalType,
        message: "MIR branch_if condition local must have XLIL bool type".to_string(),
        span: span(0, 3)
    }]);
}
...
{
    let function = MirFunction {
        name: "BadBranchIfValue".to_string(),
        parameters: vec![],
        return_type: Type::VOID,
        locals: vec![Local {
            id: LocalId(0),
...
{
    let function = MirFunction {
        name: "BadBranchIfTarget".to_string(),
        parameters: vec![],
        return_type: Type::VOID,
        locals: vec![Local {
            id: LocalId(0),
        ...
        blocks: vec![BasicBlock {
            id: MirBlockId(0),
            statements: vec![mir::Statement::ConstBool {
                local: LocalId(0),
                value: true,
                span: span(1, 2),
            }],
...
fn lowers_branch_if_terminator()
{
    ...
    assert_eq!(
        ...
        Some(Terminator::BranchIf {
            condition: crate::xlil::ValueId(0),
