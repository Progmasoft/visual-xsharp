...
impl Parser<'_>
{
    ...
    ) -> Option<Instruction>
    {
        ...
        Some(Instruction::CompareStr {
            operation: StrComparisonOperation::parse_text_stem(operation)?,
            result,
            left,
            right,
        })
