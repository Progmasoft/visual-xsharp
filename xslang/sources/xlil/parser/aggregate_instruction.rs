...
impl Parser<'_>
{
    ...
    pub(super) fn array_get_instruction(
        &mut self,
        function: &mut Function,
        result: &str,
        operands: &str,
    ...
    pub(super) fn array_set_instruction(
        &mut self,
        function: &mut Function,
        result: &str,
        operands: &str,
    ...
    pub(super) fn array_length_instruction(
        &mut self,
        function: &mut Function,
        result: &str,
        array: &str,
