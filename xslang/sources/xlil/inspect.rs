...
impl Terminator
{
  ...
  pub const fn operand(&self) -> Option<ValueId>
  {
    match *self
    {
      ...
      Self::BranchIf { condition, .. } => Some(condition),
...
impl Instruction
{
  ...
  pub const fn opcode(&self) -> &'static str
  {
    match self
    {
      ...
      Self::ConstU16 { .. } => "const.u16",
      Self::ConstInteger { .. } => "const.integer",
      Self::ConstF32 { .. } => "const.f32",
      Self::ConstF64 { .. } => "const.f64",
      Self::ConstStr { .. } => "const.str",
      Self::ConstBool { .. } => "const.bool",
      Self::BinaryInteger { .. } => "binary.integer",
      Self::BinaryFloat { .. } => "binary.float",
      Self::CompareFloat { .. } => "compare.float",
      Self::CompareStr { .. } => "compare.str",
      Self::AddI64 { .. } => "add.i64",
      Self::SubI64 { .. } => "sub.i64",
      Self::MulI64 { .. } => "mul.i64",
      Self::EqI64 { .. } => "eq.i64",
      Self::BinaryI64 { .. } => "binary.i64",
      Self::CompareI64 { .. } => "compare.i64",
      Self::AddI32 { .. } => "add.i32",
      Self::SubI32 { .. } => "sub.i32",
      Self::MulI32 { .. } => "mul.i32",
      Self::BinaryI32 { .. } => "binary.i32",
      Self::EqI32 { .. } => "eq.i32",
      Self::LtI32 { .. } => "lt.i32",
      Self::LeI32 { .. } => "le.i32",
      Self::GtI32 { .. } => "gt.i32",
  ...
  pub const fn result(&self) -> Option<ValueId>
  {
    match *self
    {
      Self::ConstI64 { result, .. } |
      Self::ConstI32 { result, .. } |
      Self::ConstU16 { result, .. } |
      Self::ConstInteger { result, .. } |
      Self::ConstF32 { result, .. } |
      Self::ConstF64 { result, .. } |
      Self::ConstBool { result, .. } |
      Self::BinaryInteger { result, .. } |
      Self::BinaryFloat { result, .. } |
      Self::CompareFloat { result, .. } |
      Self::CompareStr { result, .. } |
      Self::AddI64 { result, .. } |
      Self::SubI64 { result, .. } |
      Self::MulI64 { result, .. } |
      Self::EqI64 { result, .. } |
      Self::BinaryI64 { result, .. } |
      Self::CompareI64 { result, .. } |
      Self::AddI32 { result, .. } |
      Self::SubI32 { result, .. } |
      Self::MulI32 { result, .. } |
      Self::BinaryI32 { result, .. } |
      Self::EqI32 { result, .. } |
      Self::LtI32 { result, .. } |
      Self::LeI32 { result, .. } |
      Self::GtI32 { result, .. } |
      ...
      Self::Extract { result, .. } |
      Self::ArrayGet { result, .. } |
      Self::ArraySet { result, .. } |
      Self::ArrayLength { result, .. } |
      Self::Load { result, .. } |
      Self::ConstStr { result, .. } => Some(result),
