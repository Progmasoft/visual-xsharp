...
impl Function
{
    ...
    pub(crate) fn add_const_i64(&mut self, block: BlockId, value: i64) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstI64 {
            result,
            value,
        });
        Some(result)
    ...
    pub(crate) fn add_const_i32(&mut self, block: BlockId, value: i32) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstI32 {
            result,
            value,
        });
        Some(result)
    ...
    pub(crate) fn add_const_u16(&mut self, block: BlockId, value: u16) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstU16 {
            result,
            value,
        });
        Some(result)
    ...
    pub(crate) fn add_const_integer(&mut self, block: BlockId, value: IntegerConstant) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstInteger {
            result,
            value,
        });
        Some(result)
    ...
    pub(crate) fn add_const_f32_bits(&mut self, block: BlockId, bits: u32) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstF32 {
            result,
            bits,
        });
        Some(result)
    ...
    pub(crate) fn add_const_f64_bits(&mut self, block: BlockId, bits: u64) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstF64 {
            result,
            bits,
        });
        Some(result)
    ...
    ) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstStr {
            result,
            encoding,
            units: units.into(),
        });
    ...
    pub(crate) fn add_const_bool(&mut self, block: BlockId, value: bool) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::ConstBool {
            result,
            value,
        });
        Some(result)
    ...
    pub(crate) fn add_i64(&mut self, block: BlockId, left: ValueId, right: ValueId) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::AddI64 {
            result,
            left,
            right,
        });
    ...
    pub(crate) fn sub_i64(&mut self, block: BlockId, left: ValueId, right: ValueId) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::SubI64 {
            result,
            left,
            right,
        });
    ...
    pub(crate) fn mul_i64(&mut self, block: BlockId, left: ValueId, right: ValueId) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::MulI64 {
            result,
            left,
            right,
        });
    ...
    pub(crate) fn eq_i64(&mut self, block: BlockId, left: ValueId, right: ValueId) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::EqI64 {
            result,
            left,
            right,
        });
    ...
    ) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::BinaryI32 {
            operation,
            result,
            left,
            right,
    ...
    ) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::Aggregate {
            result,
            value_type,
            fields,
        });
    ...
    ) -> Option<ValueId>
    {
        if field_type == Type::VOID ||
            !matches!(
                self.value(aggregate)?.value_type.kind,
        ...
        self.block_mut(block)?.instructions.push(Instruction::Extract {
            result,
            aggregate,
            field,
        });
    ...
    pub(crate) fn add_load(&mut self, block: BlockId, slot: SlotId) -> Option<ValueId>
    {
        ...
        self.block_mut(block)?.instructions.push(Instruction::Load {
            result,
            slot,
        });
        Some(result)
    ...
    ) -> bool
    {
        ...
        block.terminator = Some(Terminator::BranchIf {
            condition,
            then_block,
            else_block,
        });
...
fn i32_instruction(op: I32Op, result: ValueId, left: ValueId, right: ValueId) -> Instruction
{
    match op
    {
        I32Op::Add => Instruction::AddI32 {
            result,
            left,
            right,
        },
        I32Op::Sub => Instruction::SubI32 {
            result,
            left,
            right,
        },
        I32Op::Mul => Instruction::MulI32 {
            result,
            left,
            right,
        },
        I32Op::Eq => Instruction::EqI32 {
            result,
            left,
            right,
        },
        I32Op::Lt => Instruction::LtI32 {
            result,
            left,
            right,
        },
        I32Op::Le => Instruction::LeI32 {
            result,
            left,
            right,
        },
        I32Op::Gt => Instruction::GtI32 {
            result,
            left,
            right,
        },
        I32Op::Ge => Instruction::GeI32 {
            result,
            left,
            right,
        },
...
impl Module
{
    ...
    pub(crate) fn add_aggregate_type(&mut self, name: impl Into<String>, fields: Vec<Type>) -> Option<Type>
    {
        ...
        self.aggregate_types.push(AggregateType {
            id,
            name,
            fields,
        });
    ...
    fn add_array_layout(&mut self, element_type: Type, length: Option<u64>) -> Option<Type>
    {
        ...
        self.array_types.push(ArrayType {
            id,
            element_type,
            length,
        });
