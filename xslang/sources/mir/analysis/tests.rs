...
{
  Function { name: "analysis".to_string(),
             parameters: Vec::new(),
...
fn diamond() -> Function
{
  function(vec![block(0, Terminator::BranchIf { condition: LocalId(0),
...
{
  let function = function(vec![block(0, Terminator::Goto(BlockId(2))),
...
{
  let function = function(vec![block(0, Terminator::Goto(BlockId(1))),
...
{
  let function = function(vec![block(0, Terminator::Goto(BlockId(1))),
                               block(1, Terminator::BranchIf { condition: LocalId(0),
...
fn natural_loop_merges_multiple_latches()
{
  let function = function(vec![block(0, Terminator::Goto(BlockId(1))),
                               block(1, Terminator::BranchIf { condition: LocalId(0),
                                                               ...
                                                               else_block: BlockId(3) }),
                               block(2, Terminator::Goto(BlockId(1))),
                               block(3, Terminator::BranchIf { condition: LocalId(1),
                                                               then_block: BlockId(1),
...
fn liveness_flows_values_across_a_diamond()
{
  ...
  function.blocks[0].statements = vec![Statement::ConstBool { local: LocalId(0),
                                                              value: true,
                                                              span: span() },
                                       Statement::ConstI64 { local: LocalId(1),
                                                             value: 7,
                                                             span: span() }];
  function.blocks[3].statements = vec![Statement::Use { local: LocalId(1),
                                                        span: span() }];
...
fn liveness_records_statement_boundaries()
{
  ...
  function.blocks[0].statements = vec![Statement::ConstI64 { local: LocalId(0),
                                                             value: 20,
                                                             span: span() },
                                       Statement::ConstI64 { local: LocalId(1),
                                                             value: 22,
...
fn liveness_treats_call_arguments_as_uses_and_result_as_definition()
{
  ...
  function.blocks[0].statements = vec![Statement::Call { result: Some(LocalId(1)),
