...
impl HirToMirLowerer
{
  ...
  pub(super) fn enum_data_pattern_test(&mut self,
                                       ...
                                       -> Option<mir::LocalId>
  {
    ...
    self.current_block_mut(lowered)
        .statements
        .push(mir::Statement::ConstI32 { local: expected,
                                         value,
                                         span });
  ...
  pub(super) fn bind_enum_data_pattern(&mut self,
                                       selector: mir::LocalId,
                                       selector_type: XlilType,
                                       pattern: &MatchPattern,
                                       span: Span,
                                       ...
                                       -> Option<()>
  {
    let MatchPattern::EnumDataVariant { binding,
                                        payload_type,
                                        .. } = pattern
    else
    {
  ...
  fn enum_data_pattern_layout(&mut self,
                              selector_type: XlilType,
                              pattern: &MatchPattern,
                              span: Span)
