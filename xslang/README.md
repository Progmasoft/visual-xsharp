...
control flow. `Builder::finish` verifies the completed module before returning it; lower-level public model types remain
available for readers and specialized producers.
